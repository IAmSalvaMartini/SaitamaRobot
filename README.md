...
Can be found on telegram as [Professor's Bot](https://t.me/IAmSalvaMartiniBot).

The Support group can be reached out to at [Bot Support](https://t.me/BlissVince), where you can ask for help about @IAmSalvaMArtiniBot, discover/request new features, report bugs, and stay in the loop whenever a new update is available. 
...
```
  ...
  [![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/IAmSalvaMartini/SaitamaRobot.git)

</details>  
<details>
  <summary>Steps to self Host!! </summary>

Note: This instruction set is just a copy-paste from Marie, note that [Support Group](https://t.me/BlissVince) aims to handle support for @SaitamaRobot and not how to set up your own fork. If you find this bit confusing/tough to understand then we recommend you ask a dev, kindly avoid asking how to set up the bot instance in the support chat, it aims to help our own instance of the bot and not the forks.
